        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-6 shadow-md rounded-lg border border-amber-200 dark:border-gray-700">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-amber-800 dark:text-amber-400">
                  Remember me
                </label>
              </div>
              
              <a href="#" className="text-sm font-medium text-amber-700 dark:text-amber-500 hover:text-amber-900 dark:hover:text-amber-300">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-amber-800 dark:text-amber-400">
              ...
              <Link to="/register" className="font-medium text-amber-700 dark:text-amber-500 hover:text-amber-900 dark:hover:text-amber-300">
                Sign up
              </Link>
            </p>
          </div>
